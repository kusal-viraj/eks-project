...
/*
resource "aws_subnet" "qa_connectors_private_subnet_01"{
  vpc_id      = var.vpc_id
  cidr_block  =var.qa_connectors_private_subnet_cidr_01
  availability_zone = data.aws_availability_zones.available_zone.names[0]
  map_public_ip_on_launch = true

  tags = {
    Name = "qa-connectors-private-subnet_az_01"

  }
}

resource "aws_subnet" "qa_connectors_private_subnet_02"{
  vpc_id      = var.vpc_id
  cidr_block  =var.qa_connectors_private_subnet_cidr_02
  availability_zone = data.aws_availability_zones.available_zone.names[1]
  map_public_ip_on_launch = true

  tags = {
    Name = "qa-connectors-private-subnet_az_02"
