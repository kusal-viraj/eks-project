...
resource "aws_eks_cluster" "main_eks_cluster" {
  ...
  vpc_config {
    #subnet_ids = [aws_subnet.main_public_subnet_1.id,aws_subnet.main_public_subnet_1.id,aws_subnet.main_private_app_subnet_1.id,aws_subnet.main_private_app_subnet_2.id]  # Public subnets for frontend
